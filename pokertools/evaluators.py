...
class Evaluator(ABC):
    ...
    @staticmethod
    @abstractmethod
    def evaluate(hole_cards: Iterable[Card], board_cards: Iterable[Card]) -> Hand:
...
class StandardEvaluator(Evaluator):
    ...
    @staticmethod
    def evaluate(hole_cards: Iterable[Card], board_cards: Iterable[Card] = ()) -> StandardHand:
...
class GreekEvaluator(Evaluator):
    ...
    def evaluate(hole_cards: Iterable[Card], board_cards: Iterable[Card]) -> StandardHand:
        ...
        return max(StandardEvaluator.evaluate(hole_cards, combination) for combination in combinations(board_cards, 3))
...
class ShortEvaluator(Evaluator):
    ...
    @staticmethod
    def evaluate(hole_cards: Iterable[Card], board_cards: Iterable[Card] = ()) -> ShortHand:
...
class BadugiEvaluator(Evaluator):
    ...
    @staticmethod
    def evaluate(hole_cards: Iterable[Card], board_cards: Iterable[Card] = ()) -> BadugiHand:
...
class LowballA5Evaluator(Evaluator):
    ...
    @staticmethod
    def evaluate(hole_cards: Iterable[Card], board_cards: Iterable[Card] = ()) -> LowballA5Hand:
...
class Lowball27Evaluator(Evaluator):
    ...
    @staticmethod
    def evaluate(hole_cards: Iterable[Card], board_cards: Iterable[Card] = ()) -> Lowball27Hand:
