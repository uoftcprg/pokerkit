...
class EvaluatorTestCase(TestCase):
    def test_standard_evaluator(self):
        ...
        self.assertEqual(StandardEvaluator.evaluate(
    ...
    def test_greek_evaluator(self):
        self.assertEqual(GreekEvaluator.evaluate(
            parse_cards('Ac2d'), parse_cards('QdJdTh2sKs'),
    ...
    def test_omaha_evaluator(self):
        self.assertEqual(OmahaEvaluator.evaluate(
    ...
    def test_short_deck_evaluator(self):
        self.assertRaises(
            ValueError, ShortDeckEvaluator.evaluate,
            parse_cards('AcKs'), parse_cards('4hAsKcJsTs'),
        )
        self.assertEqual(ShortDeckEvaluator.evaluate(
    ...
    def test_lowball27_evaluator(self):
        self.assertEqual(Lowball27Evaluator.evaluate(
    ...
    def test_lowballA5_evaluator(self):
        self.assertEqual(LowballA5Evaluator.evaluate(
            parse_cards('AcAd'), parse_cards('AhAsKcQdQh'),
    ...
    def test_badugi_evaluator(self):
        self.assertEqual(BadugiEvaluator.evaluate(
    ...
    def test_rank_evaluator(self):
        self.assertEqual(RankEvaluator.evaluate(
            parse_cards('AcKs'), parse_cards('AhAsKcJsTs'),
