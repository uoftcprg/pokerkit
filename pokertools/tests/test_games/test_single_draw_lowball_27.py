...
class NoLimitSingleDrawLowball27TestCase(PokerTestCaseMixin, TestCase):
    ...
    def test_hands(self):
        self.assert_terminal_poker_game(self.GAME_TYPE(Stakes(0, (1, 2)), (200, 200)).parse(
        ...
        self.assert_terminal_poker_game(self.GAME_TYPE(Stakes(1, (1, 2)), (200, 200, 100)).parse(
            'dh 2s3h4s6d7d', 'dh 2h3c4d7c8d', 'dh 2d3d4c5d7h',
            'br 6', 'br 18', 'br 54', 'br 99', 'br 199', 'cc',
            'dd', 'dd', 'dd',
        ), (True, True, True), (200, 0, 300))
        self.assert_terminal_poker_game(self.GAME_TYPE(Stakes(15, (15, 30)), (1015, 2530, 1955)).parse(
        ...
        self.assert_terminal_poker_game(self.GAME_TYPE(Stakes(1, (1, 2)), (200, 200, 100, 150)).parse(
        ...
        self.assert_terminal_poker_game(
            self.GAME_TYPE(Stakes(8750, (10000, 25000)), (1180000, 1065000, 870000, 2345000)).parse(
        ...
        self.assert_terminal_poker_game(self.GAME_TYPE(Stakes(0, (1, 2, 4)), (50, 2, 100, 150, 100, 100)).parse(
            'dh AcAdAhAsJc', 'dh 2h3c4d7c8d', 'dh 2d3d4c5d7h', 'dh KcKdKhKsJd', 'dh QcQdQhQsJh',
            'dh 7s8c9cTcJs',
            'f', 'f', 'f', 'f',
            'dd 8d 6s', 'dd',
        ...
        self.assert_terminal_poker_game(
            self.GAME_TYPE(Stakes(0, (1, 2, 4)), (50, 2, 100, 150, 100, 100, 1, 1, 1)).parse(
                'dh AcAdAhAsJc', 'dh 2h3c4d7c8d', 'dh 2d3d4c5d7h', 'dh KcKdKhKsJd', 'dh QcQdQhQsJh',
