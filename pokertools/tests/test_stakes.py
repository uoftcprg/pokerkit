...
class StakesTestCase(TestCase):
    def test_bets(self):
        ...
        self.assertEqual(Stakes(5, (1, 2, 0, 2, 2), small_bet=10).small_bet, 10)
        self.assertEqual(Stakes(5, (1, 2, 0, 2, 2), small_bet=10).big_bet, 20)
        self.assertEqual(Stakes(5, (1, 2, 0, 2, 2), small_bet=10, big_bet=25).big_bet, 25)
